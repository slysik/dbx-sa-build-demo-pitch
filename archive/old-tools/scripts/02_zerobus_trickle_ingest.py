...
# MAGIC %md
# MAGIC # Retail Streaming - Zerobus Trickle Ingestion
...
# MAGIC %pip install databricks-zerobus-ingest-sdk>=0.2.0 faker
...
TABLE_NAME = "dbx_weg.bronze.retail_streaming_events"
# Service principal credentials (created for this demo)
CLIENT_ID = "2e8cb2d1-b997-4271-a52c-a3be849886fc"
CLIENT_SECRET = dbutils.secrets.get(scope="zerobus", key="client-secret")
VOLUME_PATH = "/Volumes/dbx_weg/bronze/streaming_data"
BATCH_SIZE = 50
...
# MAGIC FROM dbx_weg.bronze.retail_streaming_events
