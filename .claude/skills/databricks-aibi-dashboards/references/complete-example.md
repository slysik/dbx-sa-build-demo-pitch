...
- [Basic Dashboard (NYC Taxi)](#basic-dashboard-nyc-taxi)
- [Dashboard with Global Filters](#dashboard-with-global-filters)

---

## Basic Dashboard (NYC Taxi)

A full end-to-end example: schema check, query validation, JSON build, and deployment.
...
A dashboard with a global region filter that affects all pages.
